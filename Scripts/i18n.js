(function () {
  ...
  var T = {
    en: {
      ...
      'exp.loreal.li1': '<strong>Data Product Build (React &amp; GCP):</strong> Designing and deploying "Find Your Customer", a user-centered React web app on GCP (versioned on GitHub) that lets business and data teams search a customer, view key information and easily access the underlying B2B and sellout data.',
      ...
      'exp.loreal.li3': '<strong>Master Data Harmonization:</strong> Structuring massive volumes of complex Master Data (Customer, Point of Sale, Sales Force Structure) from the SAP ECC and TIBCO EBX source systems into scalable, business-ready assets.',
      ...
      'exp.loreal.li5': '<strong>Personal Data Governance &amp; Compliance:</strong> Supporting the Data Protection Officers on the Commerce scope — contributing to the mapping of processing activities and data flows, checking that required compliance information is in place, following up on personal data requests and raising team awareness.',
      'exp.loreal.li6': '<strong>Run &amp; Operational Continuity:</strong> Handling requests and incidents on the assigned scope within agreed timeframes, keeping transparent follow-up on open topics and maintaining up-to-date documentation for recurring processes.',
      'exp.loreal.li7': '<strong>Cross-Functional Collaboration:</strong> Working daily with Data Product Owners and Data Engineers on the Global Commerce Transformation strategy, building a structured understanding of Commerce and Data dynamics to become an identified point of contact and share an actionable synthesis with the SDDS Commerce team.',
    ...
    fr: {
      ...
      'exp.loreal.li3': '<strong>Harmonisation des Master Data :</strong> structuration de volumes massifs de Master Data complexes (Client, Point de Vente, Structure de la Force de Vente) en actifs scalables et exploitables, à partir des systèmes sources SAP ECC et TIBCO EBX.',
      ...
      'exp.loreal.li5': '<strong>Gouvernance &amp; conformité des données personnelles :</strong> appui aux DPO sur le périmètre Commerce — participation à la cartographie des traitements et des flux de données, vérification de la présence des informations de conformité requises, suivi des demandes liées aux données personnelles et contribution à la sensibilisation des équipes.',
      'exp.loreal.li6': '<strong>Run &amp; continuité opérationnelle :</strong> traitement, dans les délais convenus, des demandes et des incidents sur le périmètre attribué ; suivi transparent des sujets ouverts et maintien d\'une documentation à jour pour les processus récurrents.',
      'exp.loreal.li7': '<strong>Collaboration inter-équipes :</strong> travail quotidien avec les Data Product Owners et les Data Engineers sur la stratégie Global Commerce Transformation, et développement d\'une compréhension structurée des dynamiques Commerce et Data pour devenir un interlocuteur identifié sur ces sujets et partager une synthèse directement exploitable avec l\'équipe SDDS Commerce.',
